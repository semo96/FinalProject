                                ...
                                <div class="widget-content-right">
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-left">
                                            <a href="{{route('sv_profile')}}"><button type="button" tabindex="0" class="dropdown-item">حساب المستخدم</button></a>

                                            <a href="{{route('logout')}}"><button type="button" tabindex="0" target="_self" class="dropdown-item">تسجيل الخروج</button></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="theme-settings__inner">
                <div class="scrollbar-container">
                    <div class="theme-settings__options-wrapper">
                        <h3 class="themeoptions-heading">خيارات التصميم
                        </h3>
                        <div class="p-3">
                            <ul class="list-group">
                                    ...
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            ...
                                            <div class="widget-content-left">
                                                <div class="widget-heading">رأس ثابت
                                                </div>
                                                <div class="widget-subheading">اجعل الرأس دائما ثابت في الاعلى ومرئي
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="list-group-item">
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            ...
                                            <div class="widget-content-left">
                                                <div class="widget-heading">تتذييل ثابت
                                                </div>
                                                <div class="widget-subheading">اجعل التذييل دائما ثابت في الاسفل ومرئي
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <h3 class="themeoptions-heading">
                            ...
                            <button type="button" class="btn-pill btn-shadow btn-wide ml-auto btn btn-focus btn-sm switch-header-cs-class" data-class="">
                                استعادة الافتراضي لخيارات الرأس
                            </button>
                        </h3>
                        <div class="p-3">
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <h5 class="pb-2"> اختار لون الموقع
                                    </h5>
                        ...
                        <h3 class="themeoptions-heading">
                            <div>خيارات المحتوى الرئيسي</div>
                            <button type="button" class="btn-pill btn-shadow btn-wide ml-auto active btn btn-focus btn-sm"> استعادة الافتراضي لخيارات المحتوى
                            </button>
                        </h3>
                        <div class="p-3">
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <h5 class="pb-2">تبويب قسم الصفحة
                                    </h5>
                                    <div class="theme-settings-swatches">
