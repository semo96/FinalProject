...
@section('page_title','تفاصيل فاتورة مرتجعات')
@section('content')
          ...
          <div class="col-md-12">
            <div class="feedback_card">
              <div class="SP-card-header">
                <h5 class="FB_title">فاتورة مرتجعات</h5>
              </div>
              <div class="card-body">
                <form>
                  ...
                  <div class="row second-section2 ">
                      <div class="col-md-12 ">
                        <div class="form-group pay_check_p">
                           ...
                           <label class="pay_check"><input type="checkbox" checked="true" disabled>نقدي</label>
                           <label class="pay_check"><input type="checkbox" unchecked="true" disabled> منتج</label>
                        </div>
                        </div>
                    ...
                    <div class="col-md-6 pr-1">
                        <div class="form-group">
                            <label>رقم الفاتورة المرتجع</label>
                             <input type="text" class="form-control2"  value="  رقم الفاتورة المرتجع" readonly>
                        </div>
                    </div>
                    <div class="col-md-6 pr-1">
                            <div class="form-group">
