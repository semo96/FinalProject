...
@section('page_title','فواتير المرتجعات')
@section('content')

<div class="box-feedback clearfix">
  <div class="feedback_title">
          <button href="#" class="  btn_title">فواتير المرتجعات </button>
  </div>
            ...
            <td class="review-ctn-hf">
             ...
             <td class="  btn-view ">  
               <div class="action_btn">
                  <a href="{{route('sp_return_bills_details')}}" target="_blank"><button type="submit" class="btn btn-primary btn-sm botao-controle  ">
